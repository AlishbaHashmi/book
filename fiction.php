          ...
          <div class="owl-carousel active_course">
            <div class="single_course">
              ...
              <div class="course_content">
                ...
                <a href="thriller.php"><span class="tag mb-4 d-inline-block">View product</span></a>
                <h4 class="mb-3">
            ...
            <div class="single_course">
              ...
              <div class="course_content">
                <span class="price">$25</span>
                <a href="horror.php"><span class="tag mb-4 d-inline-block">View product</span></a>
                <h4 class="mb-3">
            ...
            <div class="single_course">
              <div class="course_head">
              <img class="img-fluid" src="./img/novelscat/" alt="" style='height:350px'/>
              </div>
              <div class="course_content">
                <span class="price">$25</span>
                <a href="fiction.php"><span class="tag mb-4 d-inline-block">View product</span></a>
                <h4 class="mb-3">
